...
class CalendarModule:
    ...
    def authenticate(self):
        """Handle the login logic and token creation."""
        ...
        if not self.creds or not self.creds.valid:
            if self.creds and self.creds.expired and self.creds.refresh_token:
                ...
                # This will open the browser on your Pi
    ...
    def get_upcoming_events(self):
        ...
        # Fixed 'data' typo to 'date' and aligned properly
        ...
        for event in events:
            ...
            event_date = datetime.datetime.fromisoformat(start_raw.replace('Z', '')).date()
            
            # Create a label for the day
            days_diff = (event_date - today).days
            if days_diff < 0: continue
            if days_diff > 6: continue
